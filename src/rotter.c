...
output_format_t format_list [] =
{
  ...
  { "aiff24", "AIFF (Apple/SGI 24 bit PCM)",
    SNDFILE_SAMPLES_PER_FRAME, SF_FORMAT_AIFF | SF_FORMAT_PCM_24, init_sndfile },
  ...
  { "au24",   "AU (Sun/Next 24 bit PCM)",
    SNDFILE_SAMPLES_PER_FRAME, SF_FORMAT_AU   | SF_FORMAT_PCM_24, init_sndfile },
  ...
  { "caf24",  "CAF (Apple 24 bit PCM)",
    SNDFILE_SAMPLES_PER_FRAME, SF_FORMAT_CAF  | SF_FORMAT_PCM_24, init_sndfile },
  ...
  { "flac24", "FLAC 24 bit",
    SNDFILE_SAMPLES_PER_FRAME, SF_FORMAT_FLAC | SF_FORMAT_PCM_24, init_sndfile },
  { "vorbis", "Ogg Vorbis",
  ...
  { "wav24",  "WAV (Microsoft 24 bit PCM)",
    SNDFILE_SAMPLES_PER_FRAME, SF_FORMAT_WAV  | SF_FORMAT_PCM_24, init_sndfile },
